...
import DummyUMKM from "@/components/Umkm/Datacard";
import ImageAbs from "@/components/Umkm/ImageAbs";
import TabDesa from "@/components/Tab";
import TabTernak from "@/components/TabTernak";
...
const Peternakan = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/Images/ternakbg.svg')",
    ...
    >
      <ImageAbs />
      <p
        className="font-sirukota text-[75px] lg:text-[100px] text-[#25908A] text-center mt-28 lg:mt-0"
        style={{
          textShadow:
