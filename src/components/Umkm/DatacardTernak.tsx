  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="relative z-10 w-full md:w-[50%] flex flex-col-reverse md:flex-row items-center justify-center bg-white rounded-md h-auto md:h-80 shadow-[0_3px_10px_rgb(0,0,0,0.2)] hover:shadow-lg transition-all duration-300 transform hover:scale-105 overflow-hidden cursor-pointer"
      >
        <div className="w-full md:w-[60%] h-full flex flex-col justify-between p-5">
          ...
          <p className="text-sm font-poppins mt-4 text-justify">
            <p>Jumlah ternak: {data.total}</p>
            <p>Jantan dewasa: {data.jantan_dewasa}</p>
