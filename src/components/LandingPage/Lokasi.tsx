...
const Lokasi = () => {
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row items-center mx-[64px] justify-center">
        <img
        ...
        <div className="w-1/2 flex flex-col justify-center items-center">
          <div className="w-full">
            <p
              className="font-sirukota text-[120px] text-[#25908A] text-center"
              style={{
                textShadow:
          ...
          <div className="flex py-5 w-1/2 font-poppins text-[#F7ECE8] bg-[#1E6C75] rounded-[30px]  ">
          ...
          <img
            ...
            alt="Batik RangRang"
            className="w-full object-contain absolute -bottom-[150px] left-0 opacity-10 "
          />
        </div>
      </div>
    </div>
