      ...
      <div className="flex flex-col-reverse lg:flex-row items-center mx-[20px] lg:mx-[64px] justify-center">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-start">
          <div className="w-full">
            <p
              className="font-sirukota text-[24px] text-[#25908A] text-left"
              style={{
                textShadow:
            ...
            <p className="text-[36px] font-poppins font-bold text-primary">
              Nusa Penida
            </p>
          </div>
          <div className="flex py-5 w-full font-poppins text-[#F7ECE8] bg-[#1E6C75] rounded-[30px] ">
            <div className="w-full p-5">
              <p>
                <span className="font-bold">Nusa Penida, </span>
                pulau menawan di sebelah tenggara Bali, menawarkan pemandangan
                alam spektakuler dan pantai-pantai yang memukau. Dengan tebing
                curam, perairan biru jernih, dan keindahan bawah lautnya, pulau
                ini adalah surga bagi penyelam dan pecinta alam.
              </p>
            </div>
          </div>
          <img
