  ...
  return (
    ...
    >
      <img
        ...
        alt="Batik RangRang"
        className="w-full object-contain absolute -top-[100px] left-0 opacity-20 rotate-180"
      />
      <img
      ...
      <div className=" flex flex-col items-center">
        <p
          className="font-sirukota text-4xl text-primary"
          style={{
            textShadow:
        ...
        <p
          className="font-sirukota text-[100px] text-[#D7713E] -mt-[20px]"
          style={{
            textShadow:
